                                    ...
                                    <div id="tableData">
                                        <div class="d-flex flex-wrap justify-content-between mt-3">
                                            <div class="d-md-flex d-sm-block">
                                                ...
                                                <!-- Export Excel Button -->
                                                <button class="btn btn-warning mb-2 me-auto" id="import-excel-btn"
                                                    href="#" data-bs-toggle="modal" data-bs-target="#exportExcelModal">
                                        ...
                                        <table class="display border table-bordered dataTable">
                                            <thead>
                                                <tr>
                                                    <th class="p-0" style="width: 3%;"><input type="checkbox"
                                                            id="select-all"></th>
                                        ...
                                        <div class="modal fade" id="importExelModal" tabindex="-1"
                                            aria-labelledby="importExelModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <form id="importExcelForm" enctype="multipart/form-data">
                                                            <div class="mb-3">
                                                                ...
                                                                <input class="form-control" type="file"
                                                                    id="import-excel-file" name="import-excel-file"
                                                ...
                                                success: function(response) {
                                                    if (response.success) {
                                                        ...
                                                        Object.keys(updatedData).forEach((column, idx) => {
                                                            row.cells[idx + 1].innerHTML =
                                                                htmlspecialchars(updatedData[
                                                                    column]);
                                                        });
                                                        let rowData = getRowData(rowIndex);
                                        ...
                                        //Search Form
                                        $(document).off('input', '.search-tab input[type="text"]').on('input',
                                        ...
                                        function loadTabData(tabId, page) {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(data) {
                                                    ...
                                                    $(`[data-id="${tabId}"]`).closest('.nav-item').addClass(
                                                        'active');
                                                },
                                        ...
                                        function loadData(searchTerm) {
                                            $.ajax({
                                                ...
                                                success: function(responseData) {
                                                    ...
                                                    $('#tbodyData').html($(responseData).find('#tbodyData')
                                                        .html());
                                                    ...
                                                    var rows = $(responseData).find('#tbodyData tr')
                                                        .toArray().map(function(row) {
                                                            var rowData = $(row).children().map(
                                                                function() {
                                                                    return $(this).html();
                                                                }).get();
                                                            return rowData;
