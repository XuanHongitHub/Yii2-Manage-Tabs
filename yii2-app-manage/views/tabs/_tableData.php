...
<div class="modal fade" id="confirmModal" tabindex="-1" aria-labelledby="confirmModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmModalLabel">Problem</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" id="confirmMessage">Are you sure you want to continue?</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary" id="confirmYesBtn">Continue</button>
            </div>
        </div>
    </div>
</div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.success) {
                        ...
                        loadingSpinner.remove();
                        showModal('Error', 'Failed to import Excel file: ' + response.message);
                    }
                },
                error: function (xhr, status, error) {
                    loadingSpinner.remove();
                    showModal('Error', 'An error occurred while importing Excel.');
                }
            });
        });
                            ...
                            $.ajax({
                                ...
                                success: function (deleteResponse) {
                                    if (deleteResponse.success) {
                                        console.log('File tmp deleted successfully.');
                                    } else {
