                    ...
                    <div id="tableData">
                        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                            <div class="d-md-flex d-sm-block">
                                <button class="btn btn-primary me-2" id="add-data-btn" href="#" data-bs-toggle="modal"
                                ...
                                <!-- Nút Nhập Excel -->
                                <button class="btn btn-info me-2" id="import-data-btn" href="#" data-bs-toggle="modal"
                                    data-bs-target="#importExelModal">
                                    <i class="fa-solid fa-download"></i> Nhập Excel
                                </button>

                                <button class="btn btn-warning me-auto" id="export-excel-btn">
                            ...
                            <div class="btn-group ms-auto me-2">
                                <button class="btn btn-primary mx-2 dropdown-toggle" type="button"
                                ...
                                <ul class="dropdown-menu border">
                                    <table class="table table-borderless" id="columns-visibility">
                                        ...
                                        <?php 
                                            ...
                                            $isChecked = $config ? $config->is_visible : false;
                                        ?>
                            ...
                            echo GridView::widget([
                                ...
                                'layout' => "{items}\n<div class='d-flex justify-content-between align-items-center mt-3'> 
                                                        ...
                                                        <div class='go-to-page d-flex align-items-center me-md-5 mb-2 mb-md-0'> 
                                                            ...
                                                            <input class='form-control form-control-sm me-2' type='number' id='goPage' min='1' max='' style='width: 5rem;' /> 
                                                            <button id='goToPageButton' class='btn btn-primary btn-sm' onclick='loadData()'>Đi</button> 
                                                        </div> 
                                                        <div class='number-of-items d-flex align-items-center mb-2 mb-md-0'> 
                                                            <span class='me-2'>Xem:</span> 
                                                            <form method='get' action='/pages' data-pjax='true' class='form-inline' id='pageSize-form'> 
                                                            <select class='form-select form-select-sm autosubmit' id='pageSize' name='pageSize' style='width: 5rem' onchange='loadData()'> 
