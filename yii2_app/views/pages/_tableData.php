...
<div class="modal fade" id="columnsModal" tabindex="-1" aria-labelledby="columnsModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
                <button type="button" class="btn btn-primary" id="save-columns-visible">Lưu</button>
            </div>
        </div>
    </div>
</div>
...
<div id="tableData">
    ...
    <div class="d-flex flex-column flex-md-row align-items-center my-3">
        ...
        <div class="go-to-page d-flex align-items-center me-md-5 mb-2 mb-md-0">
            ...
            <input class="form-control form-control-sm me-2" type="number" id="goPage" min="1" max=""
                style="width: 5rem;" />
